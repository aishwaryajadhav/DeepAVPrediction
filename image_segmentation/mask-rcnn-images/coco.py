# python3 coco.py evaluate --dataset=../train --model=last --year=2021 --logs=image_pretrained --limit=100 > image_eval_v1.txt
# python3 coco.py train --dataset=../train --model=last --year=2021 --logs=image_pretrained > image_pretrained_v2.txt
"""
Mask R-CNN
...
class CocoConfig(Config):
    ...
    NUM_CLASSES = 1 + 40 #40 # COCO has 80 classes
...
class CocoDataset(utils.Dataset):
    def load_coco(self, dataset_dir, subset, year=DEFAULT_DATASET_YEAR, class_ids=None,
        ...
        coco = COCO("{}/annotations/instances_{}{}.json".format(dataset_dir, "train", year)) # subset
