...
fstride=10
tstride=10
base_exp_dir=../../../efs/exp/test-${dataset}-f$fstride-t$tstride-imp$imagenetpretrain-asp$audiosetpretrain-b$batch_size-lr${lr}-ensemble-mixup_0-continue
...
--label-csv ./label_index.csv --n_class 41 \
