...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Example pip insta parser:'
    ...
    label_csv = 'D:\meais\Documents\MS\CMU\Courses\11785\Project\ast-master\egs\audioset\data\\class_labels_indices.csv'       # label and indices for audioset data
