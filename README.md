...
To train the baseline Mask-RCNN model, run the following from the **mask-rcnn-images** directory:
...
To train the image + audio model, run the following from the **mask-rcnn-audio** directory:
